...
// Demonstrating the block scope
{
    ...
    var var1 = "I am visible inside the block";
    var var2 = "I am visible inside the block";
...
try {
    ...
    console.log("Error: coz the variables declared inside the block scope are not accessible outside of it");
}
